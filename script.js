...
const PRODUCTS = [
  ...
  { id:"Flatshoes",      name:"Flatshoes Cantika",              cat:"sepatu",    catLabel:"sepatu",   material:"Desain Elegant",  price:365000, img:"NALGYA/flatshoes.jpg" },
  { id:"Sling Bag",   name:"Sling Bag Nalgya",               cat:"Aksesoris", catLabel:"Aksesoris",   material:"Bahan Premium",  price:510000, img:"NALGYA/SlingBag.png" },
  { id:"Set Aksesoris",   name:"Set Aksesoris Berliana",         cat:"Aksesoris", catLabel:"Aksesoris",material:"Bahan Premium",   price:1599000, img:"NALGYA/set aksesoris.jpg" },
  { id:"Topi",  name:"Topi Wanita Summer",      cat:"Aksesoris",   catLabel:"Aksesoris",  material:"Bahan Premium",   price:250000, img:"NALGYA/topi.jpg" },
  { id:"Heels",    name:"Heels Wanita Cyntya",        cat:"sepatu",      catLabel:"sepatu",     material:"Desain Elegant",  price:400000, img:"NALGYA/heels.jpg" },
];
...
function initCatalogFrame(){
  ...
  function applyFilter(filter){
    cards.forEach((card, i)=>{
      ...
      if(match){
         card.style.animation = `fade-in .5s var(--ease) ${i*0.05}s both`;
      }
    });
  }
  ...
  function applySearch(keyword){
    ...
    cards.forEach(card=>{
        ...
        const kategori = card.dataset.cat.toLowerCase();
    ...
    if(search){
        ...
        search.addEventListener("input", ()=>{
            ...
            if(parent && parent.frames && parent.frames["mainFrame"]){
                ...
                parent.frames["mainFrame"].postMessage({
                    type:"search",
                    q: search.value
                }, "*");
